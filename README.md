...
3. **Before clicking Deploy**, go to **Environment Variables** and add:
   ...
   **How to get `MONGODB_URI`:**
   ...
   - Example: `mongodb+srv://ysahu1590_db_user:yogeshMDB90@backend-intro.bbkas2j.mongodb.net/laundry-db?retryWrites=true&w=majority`

4. Click **Deploy** and wait for the build to complete
5. Once live, your app will be available at your Vercel URL ✅

### 🔴 Common Deployment Errors

**Error: "Failed to load dashboard data"**
- ❌ MONGODB_URI not set in Vercel Environment Variables
- ✅ Add it via Vercel Dashboard → Settings → Environment Variables

**Error: "Cannot connect to MongoDB"**
- ❌ IP access not allowed in MongoDB Atlas
